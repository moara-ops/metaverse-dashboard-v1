    ...
    <v-app>
        ...
        >
            ...
            >
                ...
                <v-list-item-content>
                    <v-list-item-title>Enverse Home</v-list-item-title>
                </v-list-item-content>
            </v-list-item>
        ...
        <v-footer
            ...
            app
        >
            <span class="white--text">Enverse Dashboard {{ $store.state.globalConsts.DASHBOARD_VERSION }} | Enverse | <a class="white--text" href="https://enftr.io/#contact">Contact</a></span>
            <v-spacer></v-spacer>
